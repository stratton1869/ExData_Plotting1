...
## Filter rows for the 1st and 2nd of Feb. 2007 ##
...
with(rs, hist(rs$Global_active_power, col="red", main="Global Active Power", xlab = "Global Active Power (kilowatts)"))
